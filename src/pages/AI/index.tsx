...
const Independent: React.FC = () => {
  ...
  const [agent] = useXAgent<BubbleDataType>({
    ...
    dangerouslyApiKey:
      'Bearer sk-qzcwbimfppwcydifzgpfjfpbeooppzfhwvbtihdcdozoztwn'
  });
  ...
  const { onRequest, messages, setMessages, parsedMessages } = useXChat({
    ...
    parser: (agentMessages) => {
      console.log('🌍 ~ Independent ~ agentMessages:', agentMessages);
      return {
        ...agentMessages,
        content: {
          think: agentMessages?.thinkingContent,
          content: agentMessages?.content
        }
      };
    }
  });
  console.log('🌍 ~ Independent ~ parsedMessages:', parsedMessages);
        ...
        <Bubble.List
          ...
          roles={{
              ...
              messageRender: (item) => {
                return (
                  <>
                        ...
                        items={[
                          {
                            key: '1',
                            label: '深度思考',
                            children: <CustomMarkdown children={item?.think} />
                          }
                        ]}
                        bordered={false}
                        defaultActiveKey={['1']}
                    ...
                    <CustomMarkdown children={item?.content} />
                  </>
                );
              }
            },
            user: {
              placement: 'end',
              messageRender: (item) => {
                return <CustomMarkdown children={item?.content} />;
              }
            }
          }}
        />
